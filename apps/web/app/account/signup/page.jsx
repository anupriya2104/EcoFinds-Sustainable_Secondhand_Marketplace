    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-green-50 to-emerald-50 p-4">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-600">Create your account to start buying and selling</p>
        </div>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="overflow-hidden rounded-lg border border-gray-200 bg-white px-4 py-3 focus-within:border-green-500 focus-within:ring-1 focus-within:ring-green-500">
              <input
                required
                name="email"
                type="email"
